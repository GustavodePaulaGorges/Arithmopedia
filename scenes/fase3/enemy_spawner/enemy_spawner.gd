...
func spawn_enemy_at_ratio(ratio: float, value: int, creator_tower: TowerEntity3 = null) -> void:
...
func spawn_enemy_near_position(ratio: float, value: int, creator_tower: TowerEntity3 = null) -> void:
